  ...
  const services = [
    {
      icon: Target,
      title: "Paid Ads",
      description: "Meta, Google, TikTok campaigns that drive real ROI"
    },
    {
      icon: Users,
      title: "Social Media",
      description: "Build loyal audiences with strategic content"
    },
    {
      icon: TrendingUp,
      title: "Brand Strategy",
      description: "Authentic identity that connects with customers"
    },
    {
      icon: Zap,
      title: "Website Design",
      description: "Conversion-focused sites that generate leads"
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Every dollar spent is tracked, optimized, and designed to deliver measurable results."
    },
    {
      title: "Creative Meets Strategy",
      description: "Beautiful designs backed by data-driven strategy that actually converts."
    },
    {
      title: "Fast Communication",
      description: "Quick turnaround times and transparent reporting keep you in the loop."
    },
    {
      title: "Data-Driven Decisions",
      description: "We let the numbers guide our strategy for consistent growth."
    }
  ];
